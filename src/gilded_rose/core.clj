...
(def brie (item "Aged Brie" 2 0))
(def elixir (item "Elixir of the Mongoose" 5 7))
(def sulfuras (item "Sulfuras, Hand of Ragnaros" 0 80))
(def passes (item "Backstage passes to a TAFKAL80ETC concert" 15 20))

(defn update-current-inventory[]
  (let [inventory [vest, brie, elixir, sulfuras passes]] (update-quality inventory)))
